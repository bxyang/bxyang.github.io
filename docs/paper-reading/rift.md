...
description: "已更新作者背景、邮件评分示例与摘要翻译；后续将展开 rubric 失效分类、扎根理论、IRR 指标与自动诊断实验。"
---
...
::: info 持续更新
已完成第 0 节“论文与作者背景”与第 1 节“从一个评分失效的例子开始”。第 2—6 节保留写作大纲，后续逐节补充。
:::
...
分类与方法的原始定义参见论文正文第 3、4 节及附录 B、C、D；邮件引入案例参见附录 D；自动诊断漏检案例参见附录 E。第 2—6 节目前为写作大纲。
